...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="<?php echo base_url(); ?>agenda/Clientes" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="#agenda"  data-toggle="collapse" aria-expanded="false"  class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="<?php echo base_url(); ?>administracion/Inicio" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="#restaurant" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
